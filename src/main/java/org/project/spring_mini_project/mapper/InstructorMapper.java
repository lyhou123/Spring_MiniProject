...
public interface InstructorMapper {
    ...
    Instructor instructorCreateRequestToInstructor(InstructorUpdateRequest instructorUpdateRequest, @Context UserRepository userRepository);

    @BeanMapping(nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE)
    void updateInstructorFromRequest(@MappingTarget Instructor instructor, InstructorUpdateRequest instructorUpdateRequest);
